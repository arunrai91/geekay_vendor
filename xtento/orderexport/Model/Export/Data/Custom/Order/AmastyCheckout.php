 ...
 * ID:            %!uniqueid!%
 * Last Modified: 2024-01-10T21:02:22+00:00
...
class AmastyCheckout extends \Xtento\OrderExport\Model\Export\Data\AbstractData
{
    ...
    public function getExportData($entityType, $collectionItem)
    {
        ...
        // New module version 4.0.0
        try {
            $orderCustomFieldsCollection = $this->objectManager->get('\Amasty\CheckoutCore\Model\ResourceModel\OrderCustomFields\CollectionFactory')->create();
