...
{
    public function apply(Collection $collection, ProductModel $product, bool $inverse, bool $useLeftJoin = false): bool
    {
        ...
        return $attributeCode == 'category_ids'
            ...
            : $this->addAttributeFilter($collection, $product, $attributeCode, $equals, $useLeftJoin);
    }
    ...
    private function addAttributeFilter(
        ...
        if ($attribute->getId() || $attributeCode == ProductInterface::ATTRIBUTE_SET_ID) {
            ...
            if ($this->isAttributeMultiselect($product, $attributeCode)) {
                ...
                $condition = [$equals ? 'eq' : 'neq' => $attributeValue];
                if ($useLeftJoin) {
                    $condition['null'] = true;
                }
     ...
     * @param $equals
     */
    private function applyMultiselectAttribute(
        $collection,
        $attributeValue,
        $attributeCode,
        $equals,
