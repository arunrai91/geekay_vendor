...
namespace CyberSource\WeChatPay\Service;
...
class Soap extends \CyberSource\Core\Service\MultiMidAbstractConnection implements ClientInterface
{
    ...
    public function __construct(
        ...
        parent::__construct($scopeConfig, $logger, $this->gatewayConfig->getMerchantId($storeId), $this->gatewayConfig->getP12Certificate($storeId), $this->gatewayConfig->getP12AccessKey($storeId));
        /**
