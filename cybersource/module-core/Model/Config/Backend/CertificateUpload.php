<?php
namespace CyberSource\Core\Model\Config\Backend;
...
class CertificateUpload extends File
{
    ...
    public function beforeSave()
    {
        ...
        if ((isset($value['name']) && isset($file['name'])) || isset($value['delete'])) {
            ...
            if (!empty($file)) {
                $uploadDir = $this->_filesystem->getDirectoryWrite(DirectoryList::ROOT)->getAbsolutePath('certificate/');
                ...
                if (is_array($value) && !empty($value['delete'])) {
                    ...
                    $this->setValueAfterValidation($filePath);
                } else {
                    $this->unsValue();
                }
            }
