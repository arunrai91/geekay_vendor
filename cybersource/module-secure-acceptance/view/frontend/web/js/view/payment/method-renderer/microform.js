define(
    ...
    , function (
        ...
        return Component.extend({
            ...
            flexLoadScript: function () {
                var clientLibrary = $('input[name="clientLibrary"]').val();
                var clientLibraryIntegrity = $('input[name="clientLibraryIntegrity"]').val();
                if (typeof clientLibrary !== 'undefined' && clientLibrary !== null && clientLibrary !== '' &&
                    typeof clientLibraryIntegrity !== 'undefined' && clientLibraryIntegrity !== null && clientLibraryIntegrity !== '') {
