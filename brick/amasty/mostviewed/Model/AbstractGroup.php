...
class AbstractGroup extends Rule implements GroupInterface
{
    ...
    public function isReloadableForConfigurable(): bool
    {
        return (bool)$this->_getData(GroupInterface::IS_RELOADABLE_FOR_CONFIGURABLE);
    }

    public function setIsReloadableForConfigurable(bool $isReloadableForConfigurable): void
    {
        $this->setData(GroupInterface::IS_RELOADABLE_FOR_CONFIGURABLE, $isReloadableForConfigurable);
    }
}
